            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center space-x-6">
                        <a
                            href="https://github.com/RAVI-RM07"
                            target="_blank"
                            rel="noreferrer"
                        ...
                        <a
                            href="https://linkedin.com/in/ravipgr97"
                            target="_blank"
                            rel="noreferrer"
                            className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-all"
                            aria-label="LinkedIn"
                        ...
                        <a
                            href="mailto:ravipgr97@gmail.com"
                            className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-all"
                            aria-label="Email"
                        >
                        ...
                        <a
                            href="https://discord.gg/vzuNdfDa2y"
                            target="_blank"
                            rel="noreferrer"
                ...
                <div className="mt-8 pt-8 border-t border-gray-100 text-center text-gray-400 text-sm">
                    <p>© {new Date().getFullYear()} Ravichandran .P. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
